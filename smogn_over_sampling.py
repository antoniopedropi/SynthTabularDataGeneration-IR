# Script path: functions/smogn_over_sampling.py
...
# This script contains a function for generating synthetic observations.
# The function generates synthetic observations using the Synthetic Minority Over-Sampling Technique for Regression (SMOTER) and SMOTER-GN.
...
from functions.adjBoxplot import adjusted_boxplot_stats, box_plot_stats
...
def over_sampling(
    ...
    for i in range(n):
        max_dist[i] = adjusted_boxplot_stats(dist_matrix[i])["stats"][2] / 2
