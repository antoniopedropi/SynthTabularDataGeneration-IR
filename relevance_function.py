# Script path: functions/relevance_function.py
...
# This script contains functions for calculating the phi relevance function.
...
# The phi relevance function is calculated using a monotonic piecewise cubic spline.
# The phi relevance function is used to determine which observations exceed a given threshold.
# The phi relevance function is used to determine whether or not an observation in y is considered 'normal' or 'rare'.
