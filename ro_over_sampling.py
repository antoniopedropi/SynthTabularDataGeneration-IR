# Script path: functions/ro_over_sampling.py
...
# This script contains a function for generating synthetic observations, which is the primary function underlying the over-sampling technique utilized in the higher main function 'ro()'.
