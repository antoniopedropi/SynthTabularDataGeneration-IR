# Script path: functions/smote.py
...
# This script contains a function for the Synthetic Minority Over-sampling Technique for Regression (SMOTE) method, which applies over-sampling the minority class (rare values in a normal distribution of y, typically found at the tails).
...
from functions.smote_over_sampling import over_sampling_smote
